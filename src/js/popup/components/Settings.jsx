...
const mapDispatch = (dispatch) => ({
	updateSetting: (company, setting) => storeThunker.dispatch(changeSetting(company, setting)),
...
export default withStyles(styles)(connect(mapState, mapDispatch)(hot(module)(Settings)));
